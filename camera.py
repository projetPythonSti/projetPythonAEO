...
class Camera:
    def __init__(self, largeur_fenetre, hauteur_fenetre):
        ...
        self.deplacement = py.Vector2(0, 0)
        self.zoom = 1.0
        self.zoom_speed = 0.1
    ...
    def iso_to_screen(self, iso_pos: py.Vector2) -> tuple:
        """
    ...
    def screen_to_iso(self, screen_pos: tuple) -> py.Vector2:
        """
