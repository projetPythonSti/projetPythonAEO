...
class Projectile(pg.sprite.Sprite):
    ...
    def move(self):
        ...
        dx = self.target_entity.position.getX() - self.position.getX()  # Ensure target_entity.position is Position
        ...
        new_x = self.position.getX() + dx * self.speed
        new_y = self.position.getY() + dy * self.speed
